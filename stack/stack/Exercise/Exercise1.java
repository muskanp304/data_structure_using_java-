...
class Tester {
    ...
    public static void main(String args[]) {
        ...
        stack.push(25);
        stack.push(30);
        stack.push(40);   // Top element is 40 (even)
    ...
    public static boolean checkTop(Stack stack) {
        // if stack is empty, return false (no top element to check)
        if (stack.isEmpty()) {
            return false;
        }
        
        int topElement = stack.peek();  // get top element
        return (topElement % 2 == 0);   // check even condition
    }
}
